		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ejintegrador2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ejintegrador2-display": {
								"semanticObject": "ejintegrador2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ejintegrador2",
									"url": sap.ui.require.toUrl("ejintegrador2")
								}
							}
						}
					}
